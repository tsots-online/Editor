            ...
            <div style={{ width: "100%", height: "100%" }}>
                ...
                <div className={Classes.FILL} key="documentation-toolbar" style={{ width: "100%", height: "25px", backgroundColor: "#333333", borderRadius: "10px", marginTop: "5px", visibility: (this.state.selectedAnimatable ? "visible" : "hidden") }}>
                    <ButtonGroup className={Classes.DARK}>
                        <Button small={true} disabled={!this.state.selectedAnimation || this.state.playingAnimatables.length > 0} text="Play" icon="play" onClick={() => this._handlePlayAnimation()} />
                        <Button small={true} disabled={this.state.playingAnimatables.length === 0} text="Stop" icon="stop" onClick={() => this._handleStopAnimation()} />
                        <Divider />
                        <Button small={true} disabled={this.state.selectedTab === SelectedTab.Timeline} text="Add Single Key" icon="key" onClick={() => this._handleAddKey(SyncType.Animation)}  />
